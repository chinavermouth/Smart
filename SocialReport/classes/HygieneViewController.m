...
#import "HygieneDetailViewController.h"


@interface HygieneViewController ()
...
- (void)viewDidLoad
{
    ...
    if([myCommon.m_userPermissionAry[5][1] isEqualToString:@"1"])
...
{
    // 根据页面类型加载不同界面
    PublishViewController *publishViewController = [[PublishViewController alloc] initWithViewType:5];
...
- (void)byFirstTimeFunc
{
    ...
    strRequestURL = [NSString stringWithFormat:@"%@?communityNo=%@&tenantCode=%@&type=3&Index=2&pageIndex=%@&pageSize=10&UID=%@",HTTPURL_GETINFORMATION,[[NSUserDefaults standardUserDefaults] objectForKey:COMMUNITYNO],[[NSUserDefaults standardUserDefaults] objectForKey:TENANTCODE], [NSString stringWithFormat:@"%d", pageIndex++], [[NSUserDefaults standardUserDefaults] objectForKey:UID]];
...
- (void)byLastTimeFunc
{
    ...
    // 设置请求URL
    NSString *strRequestURL;
    strRequestURL = [NSString stringWithFormat:@"%@?communityNo=%@&tenantCode=%@&type=3&Index=1&pageIndex=%@&pageSize=10&UID=%@",HTTPURL_GETINFORMATION,[[NSUserDefaults standardUserDefaults] objectForKey:COMMUNITYNO],[[NSUserDefaults standardUserDefaults] objectForKey:TENANTCODE],[NSString stringWithFormat:@"%d", pageIndex++], [[NSUserDefaults standardUserDefaults] objectForKey:UID]];
    //    NSLog(@"strRequestURL = %@",strRequestURL);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    HygieneDetailViewController *hygieneDetailViewController = [[HygieneDetailViewController alloc] init];
    [self.navigationController pushViewController:hygieneDetailViewController animated:YES];
}
