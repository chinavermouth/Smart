//
//  HygieneDetailViewController.h
//  SocialReport
//
//  Created by J.H on 14-4-22.
...
@interface HygieneDetailViewController : UITableViewController <MBProgressHUDDelegate, AGPhotoBrowserDelegate, AGPhotoBrowserDataSource>
{
    Common *myCommon;
    MBProgressHUD *HUD;
