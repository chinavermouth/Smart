...
{
    // 根据页面类型加载不同界面
    PublishViewController *publishViewController = [[PublishViewController alloc] initWithViewType:1];
...
- (void)byFirstTimeFunc
{
    ...
    strRequestURL = [NSString stringWithFormat:@"%@?communityNo=%@&tenantCode=%@&type=1&Index=2&pageIndex=%@&pageSize=10&UID=%@",HTTPURL_GETINFORMATION,[[NSUserDefaults standardUserDefaults] objectForKey:COMMUNITYNO],[[NSUserDefaults standardUserDefaults] objectForKey:TENANTCODE], [NSString stringWithFormat:@"%d", pageIndex++], [[NSUserDefaults standardUserDefaults] objectForKey:UID]];
...
- (void)byLastTimeFunc
{
    ...
    // 设置请求URL
    NSString *strRequestURL;
    strRequestURL = [NSString stringWithFormat:@"%@?communityNo=%@&tenantCode=%@&type=1&Index=1&pageIndex=%@&pageSize=10&UID=%@",HTTPURL_GETINFORMATION,[[NSUserDefaults standardUserDefaults] objectForKey:COMMUNITYNO],[[NSUserDefaults standardUserDefaults] objectForKey:TENANTCODE],[NSString stringWithFormat:@"%d", pageIndex++], [[NSUserDefaults standardUserDefaults] objectForKey:UID]];
//    NSLog(@"strRequestURL = %@",strRequestURL);
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    PatrolDetailViewController *patrolDetailViewController = [[PatrolDetailViewController alloc] init];
    [self.navigationController pushViewController:patrolDetailViewController animated:YES];
}
